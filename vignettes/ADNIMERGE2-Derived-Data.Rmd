...
* Record collected at baseline visits regardless the baseline visit/collection date.  from the enrollment date 
...
*NOTE: * For future work, to include the sample batch of `UPENNBIOMK_MASTER` and `UPENNBIOMK_ROCHE_ELECSYS`.
