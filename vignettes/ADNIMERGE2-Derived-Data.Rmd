...
DM <- DM %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(dm_data_dic$LABEL), dm_data_dic$FLDNAME),
    .strict = TRUE
  )
```
...
SC <- SC %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(sc_data_dic$LABEL), sc_data_dic$FLDNAME),
    .strict = TRUE
  )
```
...
AE <- AE %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(ae_data_dic$LABEL), ae_data_dic$FLDNAME),
    .strict = TRUE
  )
```
...
QS <- QS %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(qs_data_dic$LABEL), qs_data_dic$FLDNAME),
    .strict = TRUE
  )
```
...
RS <- RS %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(rs_data_dic$LABEL), rs_data_dic$FLDNAME),
    .strict = TRUE
  )
```
...
NV <- NV %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(nv_data_dic$LABEL), nv_data_dic$FLDNAME),
    .strict = TRUE
  )
```
...
BS <- BS %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(bs_data_dic$LABEL), bs_data_dic$FLDNAME),
    .strict = TRUE
  )
```
...
VS <- VS %>%
  ...
  labelled::set_variable_labels(
    .labels = setNames(as.list(vs_data_dic$LABEL), vs_data_dic$FLDNAME),
    .strict = TRUE
  )
```
