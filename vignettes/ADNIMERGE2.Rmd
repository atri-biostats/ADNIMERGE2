...
The *``r pkgName``* R package is available on the data-sharing platform at [LONI website](https://adni.loni.usc.edu/). The R package `*.tar.gz` file is located in *Study Files > Data & Database* folder at the data-sharing platform. 
