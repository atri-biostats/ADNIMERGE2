...
pacc_data_dic <- bind_rows(
  ...
  c(
    ...
    TEXT = paste0(
      "Require to use enrollment flag. Please see ",
      "`get_adni_blscreen_dxsum` function for more information."
    )
  )
  # c(
  #   FLDNAME = "BLFG_MPD",
  #   LABEL = "Baseline Flag for mPACCdigit score"
  # ),
  #  c(
  #   FLDNAME = "BLFG_MPTB",
  #   LABEL = "Baseline Flag for mPACCtrialsB score"
  # )
) %>%
  tibble::as_tibble() %>%
