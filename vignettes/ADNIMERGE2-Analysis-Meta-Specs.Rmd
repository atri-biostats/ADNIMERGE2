...
adsl_dic <- bind_rows(
  ...
  c(
    ...
    origin = "Predecessor", derivation = "NV.NVSTRESC where NV.NVCAT=AMYLOIDPET, NV.NVSCAT=FBB-6MM, NV.NVTESTCD=AMYSTAT, and NVBLFL = 'Y'."
  ),
  c(
...
# Parameter code list ----
QSTESTCD_LIST <- c(
  "CDGLOBAL", "CDRSB", "DIGITSCOR", "ECOGPTT", "ECOGSPTT", "FAQTOTAL",
  "FCISCORE", "GDTOTAL", "LDELTOTL", "LIMMTOTL", "MMSCORE", "MOCA",
  "NPIQTOTL", "NPITOTAL", "RAVLTFG", "RAVLTFGP", "RAVLTIMM",
  "RAVLTLRN", "ADASTT11", "ADASTT13", "TRABSCOR"
)
