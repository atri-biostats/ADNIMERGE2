...
adsl_dic <- bind_rows(
  ...
  c(
    variable = "RURALITY", type = "text", length = "10", label = "Rurality", code_id = "RURALITY", origin = "Derived",
    derivation = "SC.SCSTRESC where SC.SCTESTCD='RURALITY' and SCBLFL = 'Y'."
  ),
  c(
...
RURALITY_CODEDLIST <- tibble(
  code_id = "RURALITY", name = "RURALITY", type = "code_decode",
  tibble(
    code = c("Urban", "Rural"),
